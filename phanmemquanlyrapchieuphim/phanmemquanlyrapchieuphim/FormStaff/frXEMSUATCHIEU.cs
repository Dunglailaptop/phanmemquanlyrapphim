...
{
    public partial class frXEMSUATCHIEU : DevExpress.XtraEditors.XtraForm
    {
        #region Peoperties
        ...
        DateTime date3;
        public frXEMSUATCHIEU(DateTime date1,int maphim)
        {
            InitializeComponent();
            Date3 = date1;
        ...
        private void BtnGhe_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //MessageBox.Show(BTN.Thoigian + BTN.Maphong.ToString() + BTN.Maphim.ToString());
                time = BTN.Text;
                //layphongtheosuatchieu(BTN.Text, Maphim, lbngaychieu.Text);
                frDATVE FR = new frDATVE(BTN.Thoigian.ToString(), BTN.Maphong, maphim, Convert.ToDateTime(dateTimePicker1.Value));
                FR.ShowDialog();
        ...
        {
            this.Hide();
            //MenuStaffdev menuStaffdev = new MenuStaffdev();
            //menuStaffdev.Show();
        }
    }
}
